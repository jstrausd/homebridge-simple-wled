        ...
        if (!(services[0] instanceof _1.Service)) {
            ...
            services.forEach(service => {
                ...
                if (service instanceof _1.Service.AccessoryInformation) {
                    ...
                    service.getCharacteristic(_1.Characteristic.Identify).removeAllListeners("set" /* SET */);
            ...
            if (informationService.getCharacteristic(_1.Characteristic.FirmwareRevision).value === "0.0.0") {
